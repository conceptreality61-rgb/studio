...
export const services: Service[] = [
  ...
  },
  {
    ...
    subCategories: [
      ...
      {
        id: 'num-showers-tubs',
        name: 'Showers and Tubs cleaning',
        type: 'single',
        options: [
          { id: '0-showers-tubs', name: '0' },
          { id: '1-showers-tubs', name: '1' },
          { id: '2-showers-tubs', name: '2' },
          { id: '3-showers-tubs', name: '3' },
          { id: '4-plus-showers-tubs', name: '4+' },
        ],
      },
      {
        id: 'num-tile-grout',
        ...
        type: 'single',
        options: [
          { id: '0-tile-grout', name: '0' },
          { id: '1-tile-grout', name: '1' },
          { id: '2-tile-grout', name: '2' },
          { id: '3-tile-grout', name: '3' },
          { id: '4-plus-tile-grout', name: '4+' },
        ],
      },
      {
        id: 'num-mirrors-fixtures',
        name: 'Mirrors and Fixtures cleaning',
        type: 'single',
        options: [
          { id: '0-mirrors-fixtures', name: '0' },
          { id: '1-mirrors-fixtures', name: '1' },
          { id: '2-mirrors-fixtures', name: '2' },
          { id: '3-mirrors-fixtures', name: '3' },
          { id: '4-plus-mirrors-fixtures', name: '4+' },
        ],
      },
    ],
  },
    ...
    subCategories: [
      {
        ...
        type: 'single',
        options: [
          { id: '0-lawn-mowing', name: '0' },
          { id: '1-lawn-mowing', name: '1' },
          { id: '2-lawn-mowing', name: '2' },
          { id: '3-plus-lawn-mowing', name: '3+' },
        ],
      },
      {
        id: 'num-pruning',
      ...
      },
      {
        ...
        type: 'single',
        options: [
          { id: '0-planting', name: '0' },
          { id: '1-planting', name: '1' },
          { id: '2-planting', name: '2' },
          { id: '3-plus-planting', name: '3+' },
        ],
      },
    ]
  },
